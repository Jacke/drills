import {
  fetchLinksCheckAndWriteDB,
  fetchLinksAndRemoveDuplicates,
  fetchNestedPages,
  fetchDatabaseEntities,
  fetchLinksNormalized,
} from './use_cases/fetch_links.js';
import { parseNestedPages } from './use_cases/parse_links_to_json.js';
// parseLinkFromReadingList
import {
  loadLinksFromRoot,
  parseJsonLinksCreateDatabases,
} from './use_cases/parse_json_url_to_db.js';
import { predefDb, predefPages } from './pages.js';
...
async function asyncTaskWithCb(cb) {
  ...
  if (!page) return cb('No page found');
